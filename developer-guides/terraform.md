...
Developer guide for the `lms-terraform` repository, the entire AWS stack as code: VPC, ALB, WAF, CloudFront, S3 static hosting, EC2 (course engine), RDS MySQL, DocumentDB, Lambda GraphQL API services, and a bastion host.
